...
file  = pd.read_csv('Assignments\week2\RealEstate-USA (1).csv',delimiter=",")

# What is a Series?
# A Pandas Series is like a column in a table.
# It is a one-dimensional array holding data of any type.

city=pd.Series("print Series",file['city'])
print(city.ndim)            #?????????????
...
#load data_file into a DataFrame object:

df=pd.DataFrame(file)


print("print dataframe" , df.dtypes)
